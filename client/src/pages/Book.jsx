                                        ...
                                        {book.imageUrls.map((url) => (
                                            <SwiperSlide key={url}>
                                                <div className="h-[300px] flex justify-center items-center">
                                                    <img src={url} alt="listing image" className="max-h-full max-w-full" />
                                                </div>
                                            </SwiperSlide>
                                        ))}
                                    </Swiper>
                                                    ...
                                                    {book.discountPrice ? (
                                                        <div>
                                                            ...
                                                            <p className='text-green-500 font-semibold italic text-2xl'>
                                                                {((book.buyPrice - book.discountPrice).toLocaleString('vi-VN'))} VNĐ (Có cho thuê)
                                                            </p>
                                                        </div>
                                                    ) : (
                                                        <p className='text-green-500 font-semibold italic text-2xl'>
                                                            {book.buyPrice.toLocaleString('vi-VN')} VNĐ (Có cho thuê)
                                                        </p>
                                                    )}
                                                </div>
                                            ) : (
                                                    ...
                                                    <div className="fixed inset-0 flex items-center justify-center z-50">
                                                        ...
                                                        <div className="w-96 p-6 bg-white rounded-lg shadow-lg text-center relative z-10">
                                                            <div className='flex flex-col'>
                                                                ...
                                                                <input type='number' min='1' max='30' value={rentalDuration} onChange={handleRentalDurationChange} />
