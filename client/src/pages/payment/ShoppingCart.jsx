                        ...
                        {cartItems.map((item) => (
                            <tr key={item._id}>
                                ...
                                <td className="text-center">
                                    {item.offer ? (item.buyPrice - item.discountPrice).toLocaleString("vi-VN") : item.buyPrice.toLocaleString("vi-VN")} VNĐ
                                </td>
                                <td>
                                ...
                                <td className="text-center">
                                    {item.offer ? ((item.buyPrice - item.discountPrice) * item.cartQuantity).toLocaleString("vi-VN") : (item.cartQuantity * item.buyPrice).toLocaleString("vi-VN")} VNĐ
                                </td>
                                <td className="text-center">
                ...
                <div className="flex flex-col gap-2 mt-14 mr-10">
                    <div className="flex gap-2">
                        ...
                        <div className="text-xl font-bold">
                            {cartItems.reduce((total, item) => item.offer
                                ? total + item.cartQuantity * (item.buyPrice - item.discountPrice)
                                : total + item.cartQuantity * (item.buyPrice), 0).toLocaleString("vi-VN")} VNĐ
                        </div>
                    </div>
                    <div className="flex">
                        <button
